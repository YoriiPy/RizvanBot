...
async def wait_send_admin(callback: CallbackQuery, state: FSMContext):
    await callback.message.answer("👤 Отправьте ID для добавления в админы", reply_markup=kb.return_start_keyboard())
